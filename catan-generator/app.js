...
function generateBoardWithRules(seedStr, options, maxAttempts = 50000) {
  ...
  console.warn("Could not generate valid board within maxAttempts, using fallback with partial constraints");
  ...
  console.error("Even fallback failed, generating completely random board");
